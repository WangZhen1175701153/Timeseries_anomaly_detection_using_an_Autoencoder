...
####Local data
df_small_noise_url = "datasets\\art_daily_small_noise.csv"
...
####Local data
df_daily_jumpsup_url = "datasets\\art_daily_jumpsup.csv"
df_daily_jumpsup = pd.read_csv(
    df_daily_jumpsup_url, parse_dates=True, index_col="timestamp"
)

####===========================Display data distribution==========================
v1 = df_small_noise['value']

plt.hist(v1)
plt.xlabel('value')
plt.ylabel('count')
plt.title('art_daily_small_noise')
plt.show()

v2 = df_daily_jumpsup['value']

plt.hist(v2)
plt.xlabel('value')
plt.ylabel('count')
plt.title('art_daily_jumpsup')
plt.show()

####===============================check nan vlaue =====================================
print("Checking to see if there is an NAn value.")
...
# Generated training sequences for the model.
